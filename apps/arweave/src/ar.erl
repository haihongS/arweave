...
parse_cli_args(["pool_mine"|Rest], C)->
	parse_cli_args(Rest, C#config { pool_mine = true });
parse_cli_args(["pool_tcp_host", PoolTcpHost|Rest], C)->
	parse_cli_args(Rest, C#config { pool_tcp_host = PoolTcpHost });
parse_cli_args(["pool_tcp_port", PoolTcpPort|Rest], C)->
	parse_cli_args(Rest, C#config { pool_tcp_port = PoolTcpPort });
...
start(
		#config{
			...
			disable = Disable,
			enable = Enable,
			pool_tcp_port = PoolTcpPort,
			pool_tcp_host = PoolTcpHost
		}
) ->
	...
	ar_meta_db:put(pool_tcp_host, PoolTcpHost),
  ar_meta_db:put(pool_tcp_port, PoolTcpPort),
